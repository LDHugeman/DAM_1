...
public class Calcular {
    ...
    public static void probar(float[][] alturas){
        for(int indiceInterno=0; indiceInterno<alturas.length;indiceInterno++){
            for(int indiceExterno=0; indiceExterno<alturas.length;indiceExterno++){
                System.out.println(indiceExterno + "    "+indiceInterno);
