...
public class Clasificar {
    ...
    public static void ordenadarClientesNombreDescendenteBurbuja(String[] nombreClientes, float[] saldos) {
        float aux;
        String aux2;
        for (int i = 0; i < nombreClientes.length - 1; i++) {
            for (int j = 0; j < nombreClientes.length - 1; j++) {
                if (nombreClientes[j] != null && nombreClientes[j + 1] != null) {
    ...
    public static void ordenadarClientesNombreAscendenteIntercambio(String[] nombreClientes, float[] saldos) {
        float aux;
        String aux2;
        ...
        while (!estaOrdenado) {
            estaOrdenado = true;
            for (int i = 0; i < nombreClientes.length - 1; i++) {
                if (nombreClientes[i] != null && nombreClientes[i + 1] != null) {
